...
const SUBGRAPH_URLS: Record<string, { decentralized: string }> = {
  ...
  "81457": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/d7gMk1zkEyCQuNVeirBYA6keCZv8hTLheCZ4DBCjRfz",
  },
};
...
function transformMarketsToTags(chainId: string, markets: Market[]): ContractTag[] {
  ...
  return validTokens.map((token) => {
    ...
    return {
      ...
      "Project Name": "Seismic",
      "UI/Website Link": "https://app.seismic.finance/",
      "Public Note": `Seismic' official ${token.name} token contract.`,
    };
  });
}
